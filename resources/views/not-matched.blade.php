  ...
  <div class="row">
    <div class="col-sm-8 p-0">
      <div class="query-container text-center">
        <h1 class="font-weight-bold mb-4 outlined-text-small" style="font-family: 'Squada One', sans-serif; font-size: 4rem;">You are incorrect!</h1>
    ...
    <div class="col-sm-4 text-center" style="padding-top: 8rem;">
      <div class="small-bg rounded px-4 py-4">
        ...
        <p style="font-size: 1.5rem;font-family: 'Days One', sans-serif;">Your final streak is {{ $streak }}.</p>
        @if(Auth::check())
          <p style="font-family: 'Inter', sans-serif;">Your updated highest streak is {{ $user->highest_streak }}.</p>
        @else
          <p style="font-family: 'Inter', sans-serif;"><a href="{{ url('/login') }}">Login</a> to save your score!</p>
        @endif
        <a href="/#" class="btn btn-primary btn-sm rounded-pill me-2" style="--bs-btn-font-size: 1.5rem; font-family: 'Days One', sans-serif;">Finish</a>
      </div>
    </div>
  </div>
</div>
